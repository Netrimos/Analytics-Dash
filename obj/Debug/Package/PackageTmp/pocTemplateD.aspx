<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pocTemplateD.aspx.cs" Inherits="AEBNDashboard.pocTemplateD" %><!DOCTYPE html><html>
<head>
...
<script src="js/map/jquery.vmap.usa.js" type="text/javascript"></script>
<script>
    $(document).ready(function () {
       ...
       // setTimeout(function () { window.location.href = document.URL }, 15000);
        ...
        jQuery('#vmap').vectorMap('set', 'colors', { FL: 'red' });
        jQuery('#vmap').vectorMap('set', 'colors', { NC: 'green' });
    });
