...
<!--meta name = "viewport" content = "initial-scale = 2.5, maximum-scale = 2.5; user-scalable = yes" -->
...
<script>
    ...
    $(document).ready(function () {
        ...
        //Calendar
        $('.calendar div').datepicker({ minDate: -500, maxDate: -1, onSelect: function (dateText, inst) { gotoDash(dateText) } });
...
<style>
        ...
        .moduleA .data .value{font-size:18px;font-weight:bold;}
        ...
        .moduleB .data .value{font-size:23px;font-weight:bolder;line-height: 90%}
    ...
    <div class="dash">
        ...
        <div class="bodyPanel round">
            <div style="position:relative;">
                <div id="leftBody" style="background-color:transparent; position:absolute; width:73%; left:0px; top:0px;height:100px;">
                   <%= de.salesLineGraph %>
                   <div class="clr" ></div>
                   <div style="position:relative;">
                        <%= de.newClientsHtml %>
                ...
                <div id="rightBody" style="background-color:none; position:absolute; width:27%; right:0px; top:0px;height:300px;">
                   <%= de.mainHtml %>
                   <%= de.salesHtml %>
                </div>
        </div>
